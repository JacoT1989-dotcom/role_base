...
import { HeroData, isCategoryHero } from "../collection-banner-types";
...
export const EditModal: React.FC<EditModalProps> = ({
  ...
  const [formData, setFormData] = useState({
    ...
    identifier: isCategoryHero(currentData)
  ...
  const handleSave = async () => {
    try {
      ...
      if (isCategoryHero(currentData)) {
        submitData.append("categoryName", formData.identifier);
      } else {
        submitData.append("collectionId", formData.identifier);
      }
      submitData.append("opacity", formData.opacity.toString());
      submitData.append("backgroundColor", currentData.backgroundColor);
        ...
        <div className="space-y-6">
          <div>
            <h2 className="text-xl font-bold mb-4">
              Edit {isCategoryHero(currentData) ? "Category" : "Collection"}{" "}
              Banner
            </h2>
          ...
          <div className="flex justify-end gap-2">
            ...
            <button
              onClick={handleSave}
              disabled={isSubmitting || !formData.title || !formData.identifier}
