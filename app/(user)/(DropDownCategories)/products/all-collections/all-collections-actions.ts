...
// Function to fetch all categories and products with real-time data
export async function getAllCategories(): Promise<CategoryActionResult> {
  try {
    console.log("🔍 Starting getAllCategories fetch");
    ...
    console.log("📦 Products fetched from database:", {
      ...
      sampleDynamicPricing: products[0]?.dynamicPricing,
    ...
    // Initialize main categories record
    ...
    // Initialize categoryProducts with empty arrays
...
// Function to fetch a single product with real-time data
...
// Function to update dynamic pricing
