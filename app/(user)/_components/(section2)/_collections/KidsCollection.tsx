...
export function KidsCollection() {
  ...
  const kidsCollection = collections.find(
    (collection): collection is BaseCollection =>
      collection.type === "kids" &&
      collection.position === COLLECTION_POSITIONS.KIDS
  );
    ...
    return (
      <div className="h-[300px]">
        <CollectionUploadControls
          ...
          type={"kids" as CollectionType}
          position={COLLECTION_POSITIONS.KIDS}
          error={error}
        />
      </div>
    );
          ...
          <div className="flex flex-col items-center space-y-4 p-6 text-center">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 max-w-[280px]">
                Create a featured collection to showcase your kids products
              </p>
            </div>
  ...
  if (!kidsCollection) return null;

  return (
    <div className="h-[300px] relative group">
      <CollectionBase
        title={kidsCollection.title}
        image={kidsCollection.image}
        href={kidsCollection.href}
        backgroundColor={kidsCollection.backgroundColor}
      />
      {isEditor && (
