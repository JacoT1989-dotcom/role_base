...
export function TshirtCollection() {
  ...
  const tshirtCollection = collections.find(
    (collection): collection is BaseCollection =>
      collection.type === "tshirt" &&
      collection.position === COLLECTION_POSITIONS.TSHIRT
  );
    ...
    return (
      <div className="h-[400px] w-full md:col-span-6 md:h-full">
        <CollectionUploadControls
          ...
          type={"tshirt" as CollectionType}
          position={COLLECTION_POSITIONS.TSHIRT}
          error={error}
        />
      </div>
    );
          ...
          <div className="flex flex-col items-center space-y-4 p-6 text-center">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-1">
                Add T-Shirt Collection
              </h3>
              <p className="text-sm text-gray-500 max-w-[280px]">
                Create a featured collection to showcase your T-shirt products
              </p>
            </div>
  ...
  return (
    <div className="h-[300px] w-full md:col-span-6 md:h-full relative group">
      <CollectionBase
        ...
        href={tshirtCollection.href}
        backgroundColor={tshirtCollection.backgroundColor}
      />
      {isEditor && (
        <CollectionEditorControls
          collection={tshirtCollection}
          onRemove={remove}
          onUpdate={update}
          error={error}
        />
