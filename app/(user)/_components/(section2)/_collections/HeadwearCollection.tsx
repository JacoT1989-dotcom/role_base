...
export function HeadwearCollection() {
  ...
  const headwearCollection = collections.find(
    (collection): collection is BaseCollection =>
      collection.type === "headwear" &&
      collection.position === COLLECTION_POSITIONS.HEADWEAR
  );
    ...
    return (
      <div className="h-[300px]">
        <CollectionUploadControls
          ...
          type={"headwear" as CollectionType}
          position={COLLECTION_POSITIONS.HEADWEAR}
          error={error}
        />
      </div>
    );
  ...
  if (!headwearCollection && isEditor) {
    return (
      <div className="h-[300px]">
        <div
          ...
          <div className="flex flex-col items-center space-y-4 p-6 text-center">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-1">
                Add Headwear Collection
              </h3>
              <p className="text-sm text-gray-500 max-w-[280px]">
                Create a featured collection to showcase your headwear products
              </p>
            </div>
  ...
  if (!headwearCollection) return null;

  return (
    <div className="h-[300px] relative group">
      <CollectionBase
        title={headwearCollection.title}
        image={headwearCollection.image}
        href={headwearCollection.href}
        backgroundColor={headwearCollection.backgroundColor}
      />
      {isEditor && (
        <CollectionEditorControls
          collection={headwearCollection}
          onRemove={remove}
          onUpdate={update}
          error={error}
        />
...
export default HeadwearCollection;
