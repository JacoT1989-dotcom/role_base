...
// Predefined collection link options
...
interface CollectionUploadControlsProps {
...
export function CollectionUploadControls({
  onUpload,
  onCancel,
  type,
  position,
  error: externalError,
}: CollectionUploadControlsProps) {
      ...
      <div className="h-full flex flex-col">
        <div className="p-6 border-b">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Configure your collection details and appearance
          </p>
        </div>
        ...
        <div className="p-6 border-t bg-white">
          <div className="flex justify-end gap-3">
            ...
            <button
              ...
              disabled={isUploading || !selectedFile || !title || !href}
            ...
            >
              {isUploading ? "Uploading..." : "Save Collection"}
            </button>
          </div>
        </div>
      </div>
