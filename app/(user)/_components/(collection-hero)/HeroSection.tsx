...
import { EmptyHeroUpload } from "./EmptyHeroUpload";
...
const HeroSection: React.FC<HeroSectionProps> = ({ heroData }) => {
  ...
  const { remove, updateWithImage, update } = useCategoryHeroStore();
