// components/VendorSearchResultsContent.tsx
"use client";
...
interface VendorSearchResultsContentProps {
  results: VendorProduct[];
  query: string;
  vendorWebsite: string;
}

export function VendorSearchResultsContent({
  results,
  query,
  vendorWebsite,
}: VendorSearchResultsContentProps) {
  return (
